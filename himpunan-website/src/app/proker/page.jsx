...
const FALLBACK_PROJECTS = [
  {
    ...
    background: 'Membangun jiwa kepemimpinan mahasiswa lintas angkatan melalui seminar bersama praktisi.',
    photos_urls: [],
  },
  {
    id: 'dummy-2',
    ...
    background: 'Meningkatkan skill konten kreatif anggota himpunan untuk kebutuhan publikasi digital.',
    photos_urls: [],
  },
  {
    id: 'dummy-3',
    ...
    background: 'Survei dan kajian terhadap layanan akademik program studi tiap semester.',
    photos_urls: [],
  },
  {
    id: 'dummy-4',
    ...
    background: 'Kegiatan sosial rutin untuk membangun kepedulian mahasiswa terhadap lingkungan sekitar kampus.',
    photos_urls: [],
  },
];
      ...
      <section className="bg-[#0F172A] py-16 lg:py-20">
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mt-4 max-w-xl text-sm text-slate-300 sm:text-base">
            Rangkaian program kerja yang telah dan sedang dijalankan oleh setiap divisi himpunan.
          </p>
        </div>
      </section>
