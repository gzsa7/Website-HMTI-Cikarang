...
const FALLBACK_PROJECTS = [
  {
    ...
    background: 'Membangun jiwa kepemimpinan mahasiswa lintas angkatan.',
    photos_urls: [],
  },
  {
    id: 'dummy-2',
    ...
    background: 'Meningkatkan skill konten kreatif anggota himpunan.',
    photos_urls: [],
  },
  {
    id: 'dummy-3',
    ...
    background: 'Survei dan kajian terhadap layanan akademik program studi.',
    photos_urls: [],
  },
];
    ...
    <div>
      ...
      <section className="relative overflow-hidden bg-[#0F172A]">
        <div className="absolute inset-0 opacity-20">
          <div className="absolute -left-24 -top-24 h-96 w-96 rounded-full bg-[#1E3A8A] blur-3xl" />
          <div className="absolute -bottom-24 -right-24 h-96 w-96 rounded-full bg-slate-500 blur-3xl" />
        </div>
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-xl text-base leading-relaxed text-slate-300 sm:text-lg">
              Platform resmi untuk mengenal profil organisasi, mengikuti program kerja, dan
              bergabung menjadi bagian dari perjalanan kami membangun mahasiswa yang aktif dan
              kritis.
            </p>
        ...
        <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-5 lg:gap-16">
          ...
          <div className="lg:col-span-3">
            ...
            <p className="mt-5 text-sm leading-relaxed text-slate-600 sm:text-base">
              Selamat datang di rumah kita bersama. Himpunan Mahasiswa hadir sebagai wadah untuk
              menyalurkan aspirasi, mengasah kemampuan, dan membangun jejaring antar mahasiswa
              lintas angkatan. Kami percaya bahwa setiap individu memiliki potensi besar untuk
              berkontribusi, dan tugas kami adalah menyediakan ruang yang tepat agar potensi itu
              dapat berkembang secara maksimal.
            </p>
            <p className="mt-4 text-sm leading-relaxed text-slate-600 sm:text-base">
              Melalui berbagai program kerja dan kegiatan yang kami rancang, harapannya setiap
              anggota dapat merasakan manfaat nyata, baik dari sisi akademik, soft skill, maupun
              relasi sosial.
            </p>
            <div className="mt-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-300">
                Kenali sejarah, visi misi, dan seluruh jajaran pengurus himpunan.
              </p>
            </div>
          </div>
          <Link
