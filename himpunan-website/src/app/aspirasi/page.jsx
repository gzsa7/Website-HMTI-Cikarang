      ...
      <section className="bg-[#0F172A] py-16 lg:py-20">
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mt-4 max-w-xl text-sm text-slate-300 sm:text-base">
            Sampaikan masukan, kritik, atau saran untuk himpunan. Identitas kamu dapat dirahasiakan.
          </p>
        </div>
      </section>
        ...
        >
          ...
          <div className="mb-5 flex items-center justify-between rounded-xl bg-slate-50 px-4 py-3.5">
            <div>
              ...
              <p className="text-xs text-slate-500">Nama kamu tidak akan ditampilkan.</p>
            </div>
            <button
              type="button"
