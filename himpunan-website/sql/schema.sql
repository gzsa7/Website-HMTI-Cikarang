...
-- =====================================================================
-- SEED DATA CONTOH (opsional, boleh dihapus/diedit)
-- =====================================================================
INSERT INTO divisions (name, description) VALUES
  ('Media & Informasi', 'Mengelola publikasi, desain, dan media sosial himpunan'),
  ('Penelitian & Pengembangan', 'Riset, kajian, dan pengembangan kompetensi anggota'),
  ('Hubungan Masyarakat', 'Relasi eksternal, kerja sama, dan kemitraan'),
  ('Acara & Kegiatan', 'Perencanaan dan eksekusi program kerja/acara')
